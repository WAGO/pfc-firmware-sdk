...
CDS3_TSCWEBSOCKETSERVER_VERSION      := 1.8.0
CDS3_TSCWEBSOCKETSERVER_MD5          := 284ce2bbd47c7e3c9ce69cb1f6c6c368
CDS3_TSCWEBSOCKETSERVER_SUFFIX       := tgz
CDS3_TSCWEBSOCKETSERVER              := cds3_cmp_wsserver_1_8_0_wsfrontend_1_0_0
...
# Clean all libCmpWSServer.so files and install the proper files and links
	...
	@ln -s $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libCmpWSServer.so.$(CDS3_TSCWEBSOCKETSERVER_VERSION) $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libCmpWSServer.so.1.8
	@ln -s $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libCmpWSServer.so.$(CDS3_TSCWEBSOCKETSERVER_VERSION) $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libCmpWSServer.so.1
...
# Clean all libSysUtil.so files and install the proper files and links
	...
	@ln -s $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libSysUtil.so.$(CDS3_TSCWEBSOCKETSERVER_VERSION) $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libSysUtil.so.1.8
	@ln -s $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libSysUtil.so.$(CDS3_TSCWEBSOCKETSERVER_VERSION) $(PKGDIR)/$(CDS3_TSCWEBSOCKETSERVER)/usr/lib/libSysUtil.so.1
