...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	rm -rf $(CDS3_TSCCURL_PLATFORMCONFIGPACKAGEDIR)/tmp/*
	cd $(CDS3_TSCCURL_PLATFORMCONFIGPACKAGEDIR)/tmp && \
	ar -xov $(CDS3_TSCCURL_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCCURL_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tsccurl, 0, 0, $(CDS3_TSCCURL_PLATFORMCONFIGPACKAGEDIR)/tmp/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
