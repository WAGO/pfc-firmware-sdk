...
void     OS_Memset(void* pvMem, unsigned char bFill, size_t ulSize);
void     OS_Memcpy(void* pvDest, const void* pvSrc, size_t ulSize);
int32_t  OS_Memcmp(const void* pvBuf1, const void* pvBuf2, size_t ulSize);
void     OS_Memmove(void* pvDest, const void* pvSrc, size_t ulSize);
...
void*    OS_FileOpen(const char* szFile, uint32_t* pulFileLen);
