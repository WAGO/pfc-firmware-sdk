 ...
 * @return
 */
i32 OsMutex_Init(tOsMutex *self) __nonnull((1));
 ...
 * @return
 */
i32 OsMutex_Deinit(tOsMutex *self) __nonnull((1));
 ...
 * @return
 */
i32 OsMutex_Lock(tOsMutex *self) __nonnull((1));
/**
 *
 * @param self
 * @return
 */
i32 OsMutex_Unlock(tOsMutex *self) __nonnull((1));
