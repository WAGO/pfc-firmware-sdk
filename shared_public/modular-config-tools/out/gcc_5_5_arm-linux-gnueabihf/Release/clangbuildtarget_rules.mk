...
$(OUT_DIR)/libconfigtoolutils.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(libconfigtoolutils.a_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libconfigtoolutils.a/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libconfigtoolutils.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(libconfigtoolutils.a_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libconfigtoolutils.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/libconfigtoolfail.a/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(libconfigtoolfail.a_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libconfigtoolfail.a/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libconfigtoolfail.a/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(libconfigtoolfail.a_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libconfigtoolfail.a/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/helloworld.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(helloworld.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/helloworld.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/helloworld.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(helloworld.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/helloworld.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/config_linux_user.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(config_linux_user.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/config_linux_user.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/config_linux_user.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(config_linux_user.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/config_linux_user.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/reserved_area.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(reserved_area.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/reserved_area.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/reserved_area.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(reserved_area.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/reserved_area.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/libconfigtoolutils_tests.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(libconfigtoolutils_tests.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libconfigtoolutils_tests.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libconfigtoolutils_tests.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(libconfigtoolutils_tests.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libconfigtoolutils_tests.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/config_linux_user_tests.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(config_linux_user_tests.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/config_linux_user_tests.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/config_linux_user_tests.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(config_linux_user_tests.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/config_linux_user_tests.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/reserved_area_tests.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(reserved_area_tests.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/reserved_area_tests.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/reserved_area_tests.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(reserved_area_tests.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/reserved_area_tests.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
