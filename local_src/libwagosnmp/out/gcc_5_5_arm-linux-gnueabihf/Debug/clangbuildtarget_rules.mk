...
$(OUT_DIR)/libwagosnmp.so/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(libwagosnmp.so_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Debug/libwagosnmp.so/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libwagosnmp.so/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(libwagosnmp.so_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Debug/libwagosnmp.so/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
