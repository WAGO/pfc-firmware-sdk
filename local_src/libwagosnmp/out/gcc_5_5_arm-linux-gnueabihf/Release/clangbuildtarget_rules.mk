...
$(DEPS_libwagosnmp.so) $(OBJS_libwagosnmp.so) $(LOBS_libwagosnmp.so) $(TIDYS_libwagosnmp.so) $(PLINTS_libwagosnmp.so) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libwagosnmp.so/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(libwagosnmp.so_CPPFLAGS)

$(DEPS_libwagosnmp.so) $(OBJS_libwagosnmp.so) $(TIDYS_libwagosnmp.so) $(PLINTS_libwagosnmp.so) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libwagosnmp.so/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(libwagosnmp.so_CXXFLAGS)

$(DEPS_libwagosnmp.so) $(OBJS_libwagosnmp.so) $(TIDYS_libwagosnmp.so) $(PLINTS_libwagosnmp.so) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libwagosnmp.so/lint_mac.h: BUILDTARGET_CFLAGS:=$(libwagosnmp.so_CFLAGS)
