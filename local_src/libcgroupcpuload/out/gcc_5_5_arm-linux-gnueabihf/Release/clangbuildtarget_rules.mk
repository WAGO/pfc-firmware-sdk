...
$(OUT_DIR)/libcgroupcpuload.so/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(libcgroupcpuload.so_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libcgroupcpuload.so/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/libcgroupcpuload.so/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(libcgroupcpuload.so_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/libcgroupcpuload.so/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/loadcompare.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(loadcompare.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/loadcompare.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/loadcompare.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(loadcompare.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/loadcompare.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/checkcpu.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(checkcpu.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/checkcpu.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/checkcpu.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(checkcpu.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/checkcpu.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/bellysmile.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(bellysmile.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/bellysmile.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/bellysmile.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(bellysmile.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/bellysmile.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/testapp.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(testapp.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/testapp.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/testapp.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(testapp.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/testapp.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(OUT_DIR)/cpuloadmonitor.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(cpuloadmonitor.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/cpuloadmonitor.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/cpuloadmonitor.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(cpuloadmonitor.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/cpuloadmonitor.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_alltests.elf) $(OBJS_alltests.elf) $(TIDYS_alltests.elf) $(PLINTS_alltests.elf) ./out/gcc_5_5_arm-linux-gnueabihf/Release/alltests.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(alltests.elf_CXXFLAGS)

$(DEPS_alltests.elf) $(OBJS_alltests.elf) $(TIDYS_alltests.elf) $(PLINTS_alltests.elf) ./out/gcc_5_5_arm-linux-gnueabihf/Release/alltests.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(alltests.elf_CFLAGS)
