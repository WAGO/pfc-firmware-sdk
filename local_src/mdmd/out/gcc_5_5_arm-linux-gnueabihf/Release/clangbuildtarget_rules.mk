...
$(DEPS_mdmd.elf) $(OBJS_mdmd.elf) $(LOBS_mdmd.elf) $(TIDYS_mdmd.elf) $(PLINTS_mdmd.elf) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdmd.elf/lint_mac.h: BUILDTARGET_CPPFLAGS:=$(mdmd.elf_CPPFLAGS)

$(DEPS_mdmd.elf) $(OBJS_mdmd.elf) $(TIDYS_mdmd.elf) $(PLINTS_mdmd.elf) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdmd.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(mdmd.elf_CXXFLAGS)

$(DEPS_mdmd.elf) $(OBJS_mdmd.elf) $(TIDYS_mdmd.elf) $(PLINTS_mdmd.elf) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdmd.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(mdmd.elf_CFLAGS)
...
$(OUT_DIR)/mdmd.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(mdmd.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdmd.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/mdmd.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(mdmd.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdmd.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
...
$(DEPS_mdm_cuse.elf) $(OBJS_mdm_cuse.elf) $(TIDYS_mdm_cuse.elf) $(PLINTS_mdm_cuse.elf) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdm_cuse.elf/lint_mac.h: BUILDTARGET_CXXFLAGS:=$(mdm_cuse.elf_CXXFLAGS)

$(DEPS_mdm_cuse.elf) $(OBJS_mdm_cuse.elf) $(TIDYS_mdm_cuse.elf) $(PLINTS_mdm_cuse.elf) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdm_cuse.elf/lint_mac.h: BUILDTARGET_CFLAGS:=$(mdm_cuse.elf_CFLAGS)
...
$(OUT_DIR)/mdm_cuse.elf/%.tidy: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(mdm_cuse.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdm_cuse.elf/%.o.d $(wildcard .clang-tidy); $(SILENT)$(call clang-tidy,$@,$<,$(FLAGS))

$(OUT_DIR)/mdm_cuse.elf/%.plint: $(PROJECT_ROOT)/% $(MK_FILES) $(LINT_SUPPORT_FILES) $(mdm_cuse.elf_PRECLANG_FILES) ./out/gcc_5_5_arm-linux-gnueabihf/Release/mdm_cuse.elf/%.o.d; $(SILENT)$(call clang-sa,$@,$<,$(FLAGS))
