...
NLOHMANN_JSON_SERIALIZE_ENUM(Autonegotiation, { {Autonegotiation::UNKNOWN, nullptr}, {Autonegotiation::ON, "on"},
                             {Autonegotiation::OFF, "off"} ,{Autonegotiation::ON, true}, {Autonegotiation::OFF, false} })
...
json InterfaceConfigsToNJson(const InterfaceConfigs &interface_configs, const FirmwareVersion& target_fw = FirmwareVersion{});
