...
/* ------------------------------------------------------------------------ */
/* Declarations for de.wago.netconfd1.event */

#define NETCONFD_TYPE_EVENT (netconfd_event_get_type ())
#define NETCONFD_EVENT(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), NETCONFD_TYPE_EVENT, netconfdEvent))
#define NETCONFD_IS_EVENT(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), NETCONFD_TYPE_EVENT))
#define NETCONFD_EVENT_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), NETCONFD_TYPE_EVENT, netconfdEventIface))

struct _netconfdEvent;
typedef struct _netconfdEvent netconfdEvent;
typedef struct _netconfdEventIface netconfdEventIface;

struct _netconfdEventIface
{
  GTypeInterface parent_iface;

  gboolean (*handle_dynamicip) (
    netconfdEvent *object,
    GDBusMethodInvocation *invocation,
    const gchar *arg_config);

  gboolean (*handle_reloadhostconf) (
    netconfdEvent *object,
    GDBusMethodInvocation *invocation);

};

GType netconfd_event_get_type (void) G_GNUC_CONST;

GDBusInterfaceInfo *netconfd_event_interface_info (void);
guint netconfd_event_override_properties (GObjectClass *klass, guint property_id_begin);


/* D-Bus method call completion functions: */
void netconfd_event_complete_dynamicip (
    netconfdEvent *object,
    GDBusMethodInvocation *invocation,
    const gchar *result);

void netconfd_event_complete_reloadhostconf (
    netconfdEvent *object,
    GDBusMethodInvocation *invocation,
    const gchar *result);
...
/* D-Bus method calls: */
void netconfd_event_call_dynamicip (
    netconfdEvent *proxy,
    const gchar *arg_config,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean netconfd_event_call_dynamicip_finish (
    netconfdEvent *proxy,
    gchar **out_result,
    GAsyncResult *res,
    GError **error);

gboolean netconfd_event_call_dynamicip_sync (
    netconfdEvent *proxy,
    const gchar *arg_config,
    gchar **out_result,
    GCancellable *cancellable,
...
void netconfd_event_call_reloadhostconf (
    netconfdEvent *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean netconfd_event_call_reloadhostconf_finish (
    netconfdEvent *proxy,
    gchar **out_result,
    GAsyncResult *res,
    GError **error);

gboolean netconfd_event_call_reloadhostconf_sync (
    netconfdEvent *proxy,
    gchar **out_result,
    GCancellable *cancellable,
    GError **error);
...
#define NETCONFD_TYPE_EVENT_PROXY (netconfd_event_proxy_get_type ())
#define NETCONFD_EVENT_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), NETCONFD_TYPE_EVENT_PROXY, netconfdEventProxy))
#define NETCONFD_EVENT_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), NETCONFD_TYPE_EVENT_PROXY, netconfdEventProxyClass))
#define NETCONFD_EVENT_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), NETCONFD_TYPE_EVENT_PROXY, netconfdEventProxyClass))
#define NETCONFD_IS_EVENT_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), NETCONFD_TYPE_EVENT_PROXY))
#define NETCONFD_IS_EVENT_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), NETCONFD_TYPE_EVENT_PROXY))

typedef struct _netconfdEventProxy netconfdEventProxy;
typedef struct _netconfdEventProxyClass netconfdEventProxyClass;
typedef struct _netconfdEventProxyPrivate netconfdEventProxyPrivate;

struct _netconfdEventProxy
{
  /*< private >*/
  GDBusProxy parent_instance;
  netconfdEventProxyPrivate *priv;
};

struct _netconfdEventProxyClass
{
  GDBusProxyClass parent_class;
};

GType netconfd_event_proxy_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (netconfdEventProxy, g_object_unref)
#endif

void netconfd_event_proxy_new (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
netconfdEvent *netconfd_event_proxy_new_finish (
    GAsyncResult        *res,
    GError             **error);
netconfdEvent *netconfd_event_proxy_new_sync (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
void netconfd_event_proxy_new_for_bus (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
netconfdEvent *netconfd_event_proxy_new_for_bus_finish (
    GAsyncResult        *res,
    GError             **error);
netconfdEvent *netconfd_event_proxy_new_for_bus_sync (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
#define NETCONFD_TYPE_EVENT_SKELETON (netconfd_event_skeleton_get_type ())
#define NETCONFD_EVENT_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), NETCONFD_TYPE_EVENT_SKELETON, netconfdEventSkeleton))
#define NETCONFD_EVENT_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), NETCONFD_TYPE_EVENT_SKELETON, netconfdEventSkeletonClass))
#define NETCONFD_EVENT_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), NETCONFD_TYPE_EVENT_SKELETON, netconfdEventSkeletonClass))
#define NETCONFD_IS_EVENT_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), NETCONFD_TYPE_EVENT_SKELETON))
#define NETCONFD_IS_EVENT_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), NETCONFD_TYPE_EVENT_SKELETON))

typedef struct _netconfdEventSkeleton netconfdEventSkeleton;
typedef struct _netconfdEventSkeletonClass netconfdEventSkeletonClass;
typedef struct _netconfdEventSkeletonPrivate netconfdEventSkeletonPrivate;

struct _netconfdEventSkeleton
{
  /*< private >*/
  GDBusInterfaceSkeleton parent_instance;
  netconfdEventSkeletonPrivate *priv;
};

struct _netconfdEventSkeletonClass
{
  GDBusInterfaceSkeletonClass parent_class;
};

GType netconfd_event_skeleton_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (netconfdEventSkeleton, g_object_unref)
#endif

netconfdEvent *netconfd_event_skeleton_new (void);
