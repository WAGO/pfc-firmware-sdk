...
libnetconf_PROJECT_ROOT = $(PROJECT_ROOT)/modules/clientapi
...
libnetconf_install_headers += $(call fglob_r,$(PROJECT_ROOT)/modules/common/inc, h hpp)
...
-I$(PROJECT_ROOT)/modules/common/inc

libnetconf.so_VERSION += 1.1.0
...
libnetconf.so_CPPFLAGS += $(call uniq, $(libnetconf.so_INCLUDES))
...
$(libnetconf.a_INCLUDES) \
-I$(PROJECT_ROOT)/modules/clientapi/extern \
...
$(libnetconf_header_install_dir)/% : $(PROJECT_ROOT)/modules/common/inc/% 
	mkdir -p $(dir $@) && cp $(realpath $<) $@
