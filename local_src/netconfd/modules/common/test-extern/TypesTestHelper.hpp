...
inline std::ostream& operator<<(std::ostream &os, const InterfaceConfig &pc) {
...
inline std::ostream& operator<<(std::ostream &os, const IPConfig &pc) {
...
inline std::ostream& operator<<(std::ostream &os, const Status &e) {
  os << e.ToString();
  return os;
}

inline std::ostream& operator<<(std::ostream &os, const StatusCode &e) {
  auto print = [&](auto s) {
    os << s;
  };
  switch (e) {
