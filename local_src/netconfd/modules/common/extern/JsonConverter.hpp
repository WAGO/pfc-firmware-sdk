...
class JsonConverter : public IJsonConvert<IPConfigs>,
  ...
  public IJsonConvert<InterfaceStatuses>,
  public IJsonConvert<netconf::DipSwitchConfig>,
  public IJsonConvert<netconf::Status>,
 ...
 public:
  ...
  Status FromJsonString(const ::std::string &str, netconf::DipSwitchConfig &out_obj) const noexcept override;

  ::std::string ToJsonString(const netconf::DipSwitchIpConfig &obj, JsonFormat format = JsonFormat::COMPACT) const
      noexcept override;
  Status FromJsonString(const ::std::string &str, netconf::DipSwitchIpConfig &out_obj) const noexcept override;

  ::std::string ToJsonString(const BridgeConfig &obj, JsonFormat format = JsonFormat::COMPACT) const noexcept override;
  Status FromJsonString(const ::std::string &str, BridgeConfig &out_obj) const noexcept override;

  ::std::string ToJsonString(const IPConfigs &obj, JsonFormat format = JsonFormat::COMPACT) const noexcept override;
  Status FromJsonString(const ::std::string &str, IPConfigs &out_obj) const noexcept override;

  ::std::string ToJsonString(const InterfaceConfigs &obj, JsonFormat format = JsonFormat::COMPACT) const noexcept override;
  Status FromJsonString(const ::std::string &str, InterfaceConfigs &out_obj) const noexcept override;

  ::std::string ToJsonString(const InterfaceStatuses &obj, JsonFormat format = JsonFormat::COMPACT) const noexcept override;
  Status FromJsonString(const ::std::string &str, InterfaceStatuses &out_obj) const noexcept override;

  ::std::string ToJsonString(const IPConfig &obj, JsonFormat format = JsonFormat::COMPACT) const noexcept override;
  Status FromJsonString(const ::std::string &str, IPConfig &out_obj) const noexcept override;

  ::std::string ToJsonString(const InterfaceConfig &obj, JsonFormat format = JsonFormat::COMPACT) const noexcept override;
  Status FromJsonString(const ::std::string &str, InterfaceConfig &out_obj) const noexcept override;

  ::std::string ToJsonString(const InterfaceInformation& obj, JsonFormat format = JsonFormat::COMPACT)const noexcept override;
  Status FromJsonString(const ::std::string& str, InterfaceInformation& out_obj)const noexcept override;

  ::std::string ToJsonString(const InterfaceInformations& obj, JsonFormat format = JsonFormat::COMPACT)const noexcept override;
  Status FromJsonString(const ::std::string& str, InterfaceInformations& out_obj)const noexcept override;

  ::std::string ToJsonString(const Status& obj, JsonFormat format = JsonFormat::COMPACT)const noexcept override;
  Status FromJsonString(const ::std::string& str, Status& out_obj)const noexcept override;
