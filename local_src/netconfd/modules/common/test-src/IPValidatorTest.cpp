...
TEST_F(AnIPValidator, ShouldValidateTwoIPConfigs) {
  ...
  IPConfigs ip_configs = { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" }, { "br1", IPSource::STATIC,
...
TEST_F(AnIPValidator, ShouldAcceptNoneToResetIpParameters) {
  ...
  IPConfigs ip_configs = { { "br0", IPSource::NONE, ZeroIP, ZeroIP }, { "br1", IPSource::STATIC, "192.168.2.1",
      "255.255.255.0" }, { "br2", IPSource::NONE, ZeroIP, ZeroIP } };
  Status status = validator_.ValidateIPConfigs(ip_configs);
...
TEST_F(AnIPValidator, FailedToValidateAnIPConfigWhichContainsOneInterfaceSeveralTimes) {
  ...
  IPConfigs ip_configs = { { "ethX1", IPSource::STATIC, "192.168.2.1", "255.255.255.0" }, { "ethX1", IPSource::STATIC,
...
TEST_F(AnIPValidator, DisregardsConfigsOfSameInterfaceInOverlappingCheck) {
  ...
  IPConfigs current_ip_configs = { { "br0", IPSource::STATIC, "192.168.1.128", "255.255.255.128" }, { "br1",
      IPSource::STATIC, "192.168.2.128", "255.255.255.128" } };

  IPConfigs new_ip_configs_totaloverlap = { { "br0", IPSource::STATIC, "192.168.1.128", "255.255.255.128" }, { "br1",
      IPSource::STATIC, "192.168.2.128", "255.255.255.128" } };

  IPConfigs new_ip_configs_partialoverlap = { { "br0", IPSource::STATIC, "192.168.1.128", "255.255.255.128" }, { "br2",
      IPSource::STATIC, "192.168.3.128", "255.255.255.128" } };
...
TEST_F(AnIPValidator, FailedToValidateIPConfigsWithSeveralIpAddresses) {
  ...
  IPConfigs ip_configs = { { "ethX1", IPSource::STATIC, "192.168.1.1", "255.255.255.0" }, { "ethX2", IPSource::STATIC,
      "192.168.2.1", "255.255.0.0", }, { "ethX3", IPSource::STATIC, "192.168.1.1", "255.0.0.0" } };
...
TEST_F(AnIPValidator, FailedToValidateIPConfigsWithSeveralNetworks) {
  ...
  IPConfigs ip_configs = { { "ethX1", IPSource::STATIC, "192.168.1.1", "255.255.255.0" }, { "ethX2", IPSource::STATIC,
      "192.168.1.2", "255.255.255.0" }, { "ethX3", IPSource::STATIC, "192.168.2.1", "255.255.255.0" } };
...
TEST_F(AnIPValidator, FailedToValidateMultipleIPConfigsWhichIPAndNetworkAlreadyExistsOnTheSystem) {
  ...
  IPConfigs ip_configs = { { "ethX4", IPSource::STATIC, "192.168.1.2", "255.255.0.0" }, { "ethX5", IPSource::STATIC,
      "192.168.2.1", "255.255.255.0" }, { "ethX6", IPSource::STATIC, "192.168.3.2", "255.255.255.0" } };
...
TEST_F(AnIPValidator, ShouldAcceptRFC3021Ips) {
  ...
  auto netmask_30 = IPConfigs { { "wwan0", IPSource::TEMPORARY, "10.12.88.128", "255.255.255.254" }, { "wwan1",
      IPSource::TEMPORARY, "10.12.88.133", "255.255.255.254" }, { "wwan2", IPSource::TEMPORARY, "10.12.88.130",
      "255.255.255.255" } };
...
INSTANTIATE_TEST_CASE_P(
    ...
    // #0 No configs can not conflict
        ...
        of( { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" } }, { }, { },
           StatusCode::INTERFACE_NOT_EXISTING),
        ...
        // #3
        of( { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" } }, { { "br0", IPSource::STATIC, "192.168.1.2",
            "255.255.255.0" } },
           { accessibleBridge("br0") }, StatusCode::OK),

        /* #4 Conflicting networks with current IPs */
        of( { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" } }, { { "br1", IPSource::STATIC, "192.168.1.2",
            "255.255.255.0" } },
           { accessibleBridge("br0"), accessibleBridge("br1") }, StatusCode::NETWORK_CONFLICT),

        // #5
        of( { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" } }, { { "br1", IPSource::DHCP, "192.168.1.2",
            "255.255.255.0" } },
           { accessibleBridge("br0"), accessibleBridge("br1") }, StatusCode::NETWORK_CONFLICT),

        /* #6 DHCP in candidate is not considered in conflicts */
        of( { { "br0", IPSource::DHCP, "192.168.1.1", "255.255.255.0" } }, { { "br1", IPSource::STATIC, "192.168.1.2",
            "255.255.255.0" } },
           { accessibleBridge("br0"), accessibleBridge("br1") }, StatusCode::OK),

        /* #7 General syntax error */
        of( { { "br0", IPSource::STATIC, "192.168.asdasd", "255.255.255.0" } }, { { "br1", IPSource::STATIC,
            "192.168.1.2", "255.255.255.0" } },
           { accessibleBridge("br0") }, StatusCode::IP_INVALID),

        // #8
        of( { { "br0", IPSource::STATIC, "192.168.1.1", "255bla" } }, { { "br1", IPSource::STATIC, "192.168.1.2",
            "255.255.255.0" } },
           { accessibleBridge("br0") }, StatusCode::NETMASK_INVALID),

        /* #9 Conflict in candidate */
        of( { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" }, { "br1", IPSource::STATIC, "192.168.1.10",
            "255.255.255.0" } },
           { { "br1", IPSource::STATIC, "192.168.2.2", "255.255.255.0" } },
           { accessibleBridge("br0"), accessibleBridge("br1") }, StatusCode::NETWORK_CONFLICT),

        /* #10 Switch current IPs should work */
        of( { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" }, { "br1", IPSource::STATIC, "192.168.2.1",
            "255.255.255.0" } },
           { { "br0", IPSource::STATIC, "192.168.2.1", "255.255.255.0" }, { "br1", IPSource::STATIC, "192.168.1.1",
               "255.255.255.0" } },
           { accessibleBridge("br0"), accessibleBridge("br1") }, StatusCode::OK),

        /* #11 override multiple IPs is OK*/
        of( { { "br0", IPSource::STATIC, "192.168.1.2", "255.255.255.0" }, { "br1", IPSource::STATIC, "192.169.1.2",
            "255.255.255.0" }, { "br2", IPSource::STATIC, "192.170.1.2", "255.255.255.0" }, { "br3", IPSource::STATIC,
            "192.171.1.2", "255.255.255.0" } },
           { { "br0", IPSource::STATIC, "192.168.1.1", "255.255.255.0" }, { "br1", IPSource::STATIC, "192.168.2.1",
               "255.255.255.0" } },
        ...
        of( { { "br1", IPSource::STATIC, "192.168.2.2", "" } }, { { "br0", IPSource::STATIC, "192.168.1.1",
            "255.255.255.0" }, { "ethX1", IPSource::NONE, "0.0.0.0", "0.0.0.0" } },
           { accessibleBridge("br0"), accessibleBridge("br1") }, StatusCode::OK),

        /* #14 IP is moved to another bridge */
        of( { { "br1", IPSource::STATIC, "192.168.1.1","255.255.255.0" }, { "br0", IPSource::STATIC, "192.168.0.1", "255.255.255.0" } },
