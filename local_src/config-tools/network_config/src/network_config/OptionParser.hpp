...
namespace network_config
{
  ...
  struct FormatOption {
      explicit FormatOption(std::string val) : value(::std::move(val)) { }
      std::string value;
  ...
  struct AutonegOption {
      explicit AutonegOption(std::string val) : value(::std::move(val)) { }
      std::string value;
  ...
  struct SpeedOption {
      explicit SpeedOption(std::string val) : value(::std::move(val)) { }
      std::string value;
  ...
  struct DuplexOption {
      explicit DuplexOption(std::string val) : value(::std::move(val)) { }
      std::string value;
  ...
  struct StateOption {
      explicit StateOption(std::string val) : value(::std::move(val)) { }
      std::string value;
