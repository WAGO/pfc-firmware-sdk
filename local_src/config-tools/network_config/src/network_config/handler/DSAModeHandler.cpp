...
namespace network_config
{
  ...
  void DSAModeHandler::SetConfig()
  {
    ...
    {
      netconf::Error e{netconf::ErrorCode::GENERIC_ERROR, "Can not set the dsa mode because '"
          + dsa_mode + "' is no valid value. Your options are '0' for switched and '1' for separated mode."};
    }
