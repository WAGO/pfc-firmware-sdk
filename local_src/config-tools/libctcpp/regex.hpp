...
/// \file regex.hpp
/// 
/// \version $Id: regex.hpp 13475 2015-06-26 14:12:20Z mariusz.podlesny@wago.com $ 
/// 
...
public:
    ...
    inline GRegex* get(void) const
            { return rexobj; }
    inline GRegex* release(void)
...
public:
    ...
    inline GMatchInfo* get(void) const
            { return info; }
    inline GMatchInfo* release(void)
