...
/// \file xmlhlp.hpp
/// 
/// \version $Id: xmlhlp.hpp 13475 2015-06-26 14:12:20Z mariusz.podlesny@wago.com $ 
/// 
...
{
public:
    explicit inline xmldoc(xmlDoc* const _doc = NULL)
            : doc(_doc) {}
    ...
    inline xmlDoc* get(void) const
            { return doc; }
    inline xmlDoc* release(void)
...
{
public:
    explicit inline xmlnode(xmlNode* const _node = NULL)
            : node(_node) {}
    ...
    inline xmlNode* get(void) const
            { return node; }
    inline xmlNode* release(void)
...
{
public:
    explicit inline xmlattr(xmlAttr* const _attr = NULL)
            : attr(_attr) {}
    ...
    inline xmlAttr* get(void) const
            { return attr; }
    inline xmlAttr* release(void)
...
{
public:
    explicit inline xmlctx(xmlXPathContext* const _ctx = NULL)
            : ctx(_ctx) {}
    ...
    inline xmlXPathContext* get() const
            { return ctx; }
    inline xmlXPathContext* release()
...
{
public:
    explicit inline xmlpathobj(xmlXPathObject* const _obj = NULL)
            : obj(_obj) {}
    ...
    inline xmlXPathObject* get(void) const
            { return obj; }
    inline xmlXPathObject* release(void)
